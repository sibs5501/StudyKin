...
INSERT INTO storage.buckets (id, name, public) VALUES 
  ...
  ('group-voice', 'group-voice', false);

-- Storage policies for group images (public)
...
-- Storage policies for voice notes (private to group members)
...
CREATE POLICY "Group members can upload voice notes" 
ON storage.objects 
FOR INSERT 
WITH CHECK (
  bucket_id = 'group-voice' AND 
